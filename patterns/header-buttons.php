 ...
 * Slug: blocklane/header-buttons
 * Categories: header
 * Keywords: header, navigation, buttons, call to action, conversion, demo request
 * Block Types: core/template-part/header
 * Viewport Width: 1400
 * Description: Single-row header pairing logo and navigation with two call-to-action buttons on the right. The standard marketing header - reach for it when the site has a primary conversion action such as a signup or demo request.
 *
	...
	<div class="wp-block-group">
		...
		<div class="wp-block-group">
			...
			<div class="wp-block-buttons">
				...
				<div class="wp-block-button has-custom-font-size is-style-ghost has-small-font-size"><a class="wp-block-button__link wp-element-button" href="#">Log In</a></div>
				<!-- /wp:button -->
